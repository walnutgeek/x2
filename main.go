...
// According: https://github.com/kjk/the-code/blob/master/LICENSE
// All of the code has been dedicated to the public domain by the authors.
// See: https://en.wikipedia.org/wiki/Public_domain

// You can use it any way you want, without attribution.
